...
/**
 * Displays the current user's avatar + name/username inside the NewPost modal.
 * If no user is logged in, shows Login / Register buttons instead.
 *
 * Props
 * ─────
 ...
 */
export default function NewPostProfile({ user, onClose }) {
  if (!user) {
    return (
